...
module SwaggerClient
  ...
  class PostV2Hooks
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'search_id')
    ...
    def list_invalid_properties
      ...
      if @search_id.nil?
        invalid_properties.push("invalid value for 'search_id', search_id cannot be nil.")
      end
