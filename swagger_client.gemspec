...
Gem::Specification.new do |s|
  ...
  s.email       = ["support@api.meltwater.com"]
  s.homepage    = "https://github.com/swagger-api/swagger-codegen"
  s.summary     = "Meltwater Streaming API v2 Ruby Gem"
  s.description = "The Meltwater Streaming API provides the needed resources for Meltwater clients to create & delete REST Hooks and stream Meltwater search results to your specified destination."
